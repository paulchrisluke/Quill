...
When adding images to the theme, we need to add the license attribution to the readme.txt file. For Quill almost all images come from rawpixel.com, and we have stored them [in this folder](https://tinyurl.com/tt5-images).
